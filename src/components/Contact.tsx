...
export default function Contact() {
  ...
  return (
    <footer ref={sectionRef} id="contact" className="w-full min-h-screen px-6 md:px-12 lg:px-24 bg-charcoal text-stone flex flex-col items-center justify-center">
      <div className="max-w-7xl w-full mx-auto flex flex-col justify-between flex-1 py-12 md:py-16">
        
        {/* Spacing to push content down if needed, but flex-col + justify-between handles it */}
        <div className="flex flex-col gap-12 md:gap-16 my-auto">
        ...
        {/* Bottom Footer */}
        <div className="pt-8 mt-16 border-t border-stone/10 flex flex-col md:flex-row justify-between items-center text-xs text-stone/40">
